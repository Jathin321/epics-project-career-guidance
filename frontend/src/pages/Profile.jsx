...
export default function Profile() {
  ...
  const loadData = async () => {
    ...
    console.log(curr_user[0].favorites);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-3 py-5 ml-4">
            ...
            <div className="overflow-y-auto h-96">
              {" "}
              {/* max-h-96 sets maximum height, adjust as needed */}
              {favorites.length !== 0 ? (
                favorites.map((item) => (
                    ...
                    <div className="mt-4">
                      <div className="bg-white shadow-lg rounded-2xl p-4">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 inline-flex justify-center items-center h-12 text-white bg-gradient-to-br from-pink-500 to-violet-500 rounded-lg">
                            <svg
                              className="h-8"
                              fill="currentColor"
                              viewBox="0 0 20 20"
